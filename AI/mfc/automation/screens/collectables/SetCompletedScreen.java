...
import static com.myproject.automation.enums.collectables.ItemsState.BRONZE;
...
public class SetCompletedScreen extends BaseScreen {
    ...
    private static final String LOC_REWARD_PACK = "RewardPack(Clone)>AmountText TextMeshProUGUI";
    private static final String LOC_REWARD_PACK_IMG = "RewardPack(Clone)>IconImage Image";
    ...
    private final WsText txtCoinReward = new WsText("Coins(Clone)>JackpotValue_Text TextMeshProUGUI", "Coins Text");
    private final WsText txtLightningReward = new WsText("Lightning(Clone)>JackpotValue_Text TextMeshProUGUI", "Lightning Text");
    ...
    public boolean isBronzeTurnedToSilver() {
        AwaitilityWrapper.waitForCondition(() -> getNumberOfContainers(BRONZE) == CollectablesSet.BRONZE.getItemsCount(),
