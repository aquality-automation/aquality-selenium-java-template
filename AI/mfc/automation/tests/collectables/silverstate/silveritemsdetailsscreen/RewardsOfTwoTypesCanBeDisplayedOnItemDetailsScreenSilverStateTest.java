...
public class RewardsOfTwoTypesCanBeDisplayedOnItemDetailsScreenSilverStateTest extends BasePMTest {
    ...
    public void rewardsOfTwoTypesCanBeDisplayedOnItemDetailsScreenSilverStateTest() {
        setSilverState(user);
