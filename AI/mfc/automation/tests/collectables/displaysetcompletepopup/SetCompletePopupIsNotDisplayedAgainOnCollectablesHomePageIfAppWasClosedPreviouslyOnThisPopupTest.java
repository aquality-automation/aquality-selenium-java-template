...
public class SetCompletePopupIsNotDisplayedAgainOnCollectablesHomePageIfAppWasClosedPreviouslyOnThisPopupTest extends BasePMTest {

    private static final int SUM_OF_LIGHTNING_REWARDS = 800;
    private static final int SUM_OF_COIN_REWARDS = 125000;

    @Link(name = "CA-4451", type = "icq")
    @TmsLink("10200643")
    @Test(groups = {"collectables", "base_collectables", "base_allocated_item", "base_collect_rewards"})
    public void setCompletePopupIsNotDisplayedAgainOnCollectablesHomePageIfAppWasClosedPreviouslyOnThisPopupTest() {
