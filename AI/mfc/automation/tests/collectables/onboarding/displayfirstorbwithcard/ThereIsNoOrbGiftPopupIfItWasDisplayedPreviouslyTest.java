...
public class ThereIsNoOrbGiftPopupIfItWasDisplayedPreviouslyTest extends BasePMTest {

    @Link(name = "CA-4811", type = "icq")
    @TmsLink("6507404")
    @Test(groups = {"collectables", "base_tutorial", "base_collectables", "base_allocated_item", "base_collect_rewards"})
    public void thereIsNoOrbGiftPopupIfItWasDisplayedPreviouslyTest() {
